                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col" style="padding-left: 4px;margin-left: 281px;margin-right: -324px;">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="name"><strong>Username</strong></label><input class="form-control" type="text" id="name" placeholder="{{ Auth::user()->name }}" name="name"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="password"><strong>Password</strong><br></label><input class="form-control" type="text" id="password" placeholder="password" name="password"></div>
                                                    </div>
                                                </div>
