...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <li class="nav-item"><a class="nav-link" href="wyniki"><i class="fas fa-tachometer-alt"></i><span>Testy</span></a></li>
                </ul>
    ...
    <i class="fas fa-sign-out-alt fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Logout
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Twoje testy</h3>
                    <div class="row">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $test->klasa }}</td>
                                    <td>
                                    <a href="{{ route('testy.start', $test->id) }}" class="btn btn-primary">Wykonaj test</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
