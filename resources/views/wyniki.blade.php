...
<head>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', (event) => {
            let results = JSON.parse('{!! addslashes(json_encode(session('results'))) !!}');
            if (results) {
                let alertText = '';
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href="userTests"><i class="fas fa-tachometer-alt"></i><span>Testy</span></a></li>
                </ul>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6">
                            <h3 class="text-dark mb-4">Wyniki studenta</h3>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table tablesorter" id="ipi-table">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th class="text-center">Nazwa studenta</th>
                                                <th class="text-center">Nazwa testu</th>
